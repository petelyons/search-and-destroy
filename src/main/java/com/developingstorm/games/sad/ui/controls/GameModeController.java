    ...
    public GameModeController(SaDFrame frame, GameCommander commander) {
        ...
        keyListener = new KeyListener() {
            ...
            public void keyPressed(KeyEvent ke) {
                ...
                Location loc =
                    GameModeController.this.commander.getCurrentLocation();
                ...
                switch (ke.getKeyCode()) {
                    ...
                    case KeyEvent.VK_U:
                        ...
                        break;
                    case KeyEvent.VK_T:
                        currentAction = new MoveController(
                            GameModeController.this.commander,
            ...
            new IHexMouseListener() {
                ...
                public void hexMousePressed(MouseEvent e, BoardHex hex) {
                    ...
                    if (button == MouseEvent.BUTTON1) {
                        if (
                            GameModeController.this.commander.isDraggable(hex)
                        ) {
                            mouseDown = hex;
                        }
                    }
                ...
                public void hexMouseReleased(MouseEvent e, BoardHex hex) {
                    ...
                    if (button == MouseEvent.BUTTON1 && !e.isPopupTrigger()) {
                        if (GameModeController.this.mouseDown != null) {
                            GameModeController.this.commander.showLine(
                                null,
                                null
                            );
                            if (
                                !GameModeController.this.mouseDown.getLocation().equals(
                                    loc
                                )
                            ) {
                                GameModeController.this.commander.move(
                                    GameModeController.this.mouseDown.getLocation(),
                                    loc
                                );
                            } else {
            ...
            new IHexMouseMotionListener() {
                ...
                public void hexMouseDragged(MouseEvent e, BoardHex hex) {
                    ...
                    if (GameModeController.this.mouseDown != null) {
                        if (
                            hex != null &&
                            !hex.equals(GameModeController.this.mouseDown)
                        ) {
                            GameModeController.this.commander.showLine(
                                GameModeController.this.mouseDown.getLocation(),
                                hex.getLocation()
                ...
                public void hexMouseMoved(MouseEvent e, BoardHex hex) {
                    if (hex != null && hex.getLocation() != null) {
                        GameModeController.this.commander.trackLocation(
                            hex.getLocation()
                        );
                    }
                }
